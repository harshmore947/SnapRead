...
export default function UploadHeader() {
  return (
        <div className="flex flex-col items-center justify-center gap-6 text-center">
          <div className="relative px-[2px] py-[2px] overflow-hidden rounded-full bg-linear-to-r from-rose-200 via-rose-500 to-rose-800 animate-gradient-x group">
            <Badge
              variant={"secondary"}
          ...
          <div className="mt-2 text-lg leading-8 text-gray-600 max-w-2xl text-center">
            <p>Upload you pdf and let ai do your magic! ✨</p>
          </div>
        </div>
  );
}
